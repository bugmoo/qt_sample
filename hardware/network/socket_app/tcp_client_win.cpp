...
CTcpClientWin::CTcpClientWin(CTcpClient* tcp_client_class)
{
    m_object = tcp_client_class;
    m_timeID = -1;
    initUI();

}

CTcpClientWin::~CTcpClientWin()
{

}
/**
 * @brief CTcpClientWin::timerEvent 定时器显示网络消息
 * @param event
 */
void CTcpClientWin::timerEvent(QTimerEvent *event)
{
...
/**
 * @brief CTcpClientWin::clickBtnOpen 连接
 */
void CTcpClientWin::clickBtnOpen()
{
...
/**
 * @brief CTcpClientWin::clickBtnClose 断开
 */
void CTcpClientWin::clickBtnClose()
{
    QPushButton * btnOpen = this->findChild<QPushButton *>("btnOpen");
    QPushButton * btnClose = this->findChild<QPushButton *>("btnClose");
    QPushButton * btnSend = this->findChild<QPushButton *>("btnSend");
...
/**
 * @brief CTcpClientWin::clickBtnSend 发送
 */
void CTcpClientWin::clickBtnSend()
{
...
/**
 * @brief CTcpClientWin::clickBtnClear 清空接收窗口
 */
void CTcpClientWin::clickBtnClear()
{
    QPlainTextEdit * edtRecv = this->findChild<QPlainTextEdit *>("edtRecv");
    edtRecv->clear();
}
/**
 * @brief CTcpClientWin::closeEvent 窗口关闭事件
 * @param event
 * @note 不断开网络
 */
void CTcpClientWin::closeEvent(QCloseEvent *event)
{
    if(m_timeID != -1)
    {
        killTimer(m_timeID);
...
/**
 * @brief CTcpClientWin::initUI 初始化界面元素和布局
 */
void CTcpClientWin::initUI()
{
    // 布局
    ...
    connect(btnOpen, &QPushButton::clicked, this, &CTcpClientWin::clickBtnOpen);
    connect(btnClose, &QPushButton::clicked, this, &CTcpClientWin::clickBtnClose);
    connect(btnSend, &QPushButton::clicked, this, &CTcpClientWin::clickBtnSend);
    connect(btnClear, &QPushButton::clicked, this, &CTcpClientWin::clickBtnClear);
...
/**
 * @brief CTcpClientWin::deleteUI 清空界面元素和布局
 */
void CTcpClientWin::deleteUI()
{
